    ...
    public class RussianIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure()
        {
            return new IdentityError
            {
                ...
                Description = "Ошибка параллелизма. Объект был изменён."
            };
        }
        ...
        public override IdentityError InvalidUserName(string? userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Имя пользователя '{userName}' недопустимо. Используйте только буквы и цифры."
            };
        }
        ...
        public override IdentityError InvalidRoleName(string? role)
        {
            return new IdentityError
            {
                ...
                Description = $"Название роли '{role}' недопустимо."
            };
        }
        ...
        public override IdentityError UserLockoutNotEnabled()
        {
            return new IdentityError
            {
                ...
                Description = "Блокировка не включена для данного пользователя."
            };
        }
